		...
		<table class="table table-striped table-center">
			...
			<tbody class="sort" data-table="<?php echo $c_abonnement_vertrag->get_tablename(); ?>">
				<?php foreach($vertraege AS $buff) { 
					$letzte_rechnung = $c_abonnement_vertrag_rechnung_position->get_letzte_rechnung($buff['abonnement_vertrag_id']);
				?>
					<tr class="<?php echo $c_abonnement_vertrag->get_faellig_tr_class($buff['naechste_faelligkeit']); ?>" data-id="<?php echo $buff['abonnement_vertrag_id']; ?>">
						<td>
						...
						<td>
							...
							<?php echo $c_html->get_abonnement_position_letzte_rechnung_label($letzte_rechnung); ?>
						</td>
						<td>
							<?php echo $c_helper->german_date_no_time($buff['start']); ?>
						</td>
						<td>
							<?php echo $c_abonnement_vertrag->get_naechste_faelligkeit($buff); ?>
							<br>
