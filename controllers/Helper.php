...
class Helper {
	...
	public function get_monat_label($monat) {
		...
		else if($monat == 2) return 'Februar';
		else if($monat == 3) return 'März';
		else if($monat == 4) return 'April';
		else if($monat == 5) return 'Mai';
		else if($monat == 6) return 'Juni';
		else if($monat == 7) return 'Juli';
		else if($monat == 8) return 'August';
		else if($monat == 9) return 'September';
		else if($monat == 10) return 'Oktober';
		else if($monat == 11) return 'November';
		else if($monat == 12) return 'Dezember';
	}
