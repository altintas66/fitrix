...
class Ort { 
	...
	**/
	...
	public function get_by_ortsname($ortsname) 
	{
		$sql = "SELECT 
				".$this->get_fields()."
			FROM ".$this->get_tablename()."
			WHERE ".$this->get_tablename().".ortsname = '".$ortsname."'";
