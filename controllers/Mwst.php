...
class Mwst { 
	...
	public function __construct($db, $helper, $artikel) 
	{
		$this->db             = $db;
		$this->helper         = $helper;
	...
	public function set_fields($tablename) 
	{
		$this->fields = "
			...
			".$tablename.".steuersatz                    AS 'steuersatz'
		";
	}
	...
	public function update($post) 
	{
		...
		$sql ="
			UPDATE ".$this->get_tablename()." SET 
				...
				steuersatz       = ".intval($values['steuersatz'])."
