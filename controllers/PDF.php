...
class PDF {
    ...
    {
        global $c_angebot, $c_helper, $c_html, $c_einstellungen, $c_table_helper;
    ...
    public function generiere_rechnung_pdf($id) 
    {
        ...
        global $c_rechnung, $c_helper, $c_html, $c_einstellungen, $c_rechnung_position, $c_xml, $c_table_helper;
