...
/*============================
 [Table of JS]
    ...
    9.  Rechnungen direkt aus dem Abonnement erstellen
...
-----------------------*/
    ...
    $(document).ready(function() { 
        ...
        $('.js_abonnement_rechnungen_erstellen').click(function() { 
            if(confirm('Sicher? Rechnungen werden automatisch generiert.') == false) return;
            ajax_abonnement_rechnungen_erstellen($(this).attr('data-id'));
        });



        function ajax_abonnement_rechnungen_erstellen(abonnement_id) {
            
            var data = {
                action              : 'abonnement_rechnungen_erstellen',
            ...
            $.ajax({
                ...
                success: function (success) {
                    ...
                    if(obj.result == true) {
                        location.reload();
                    } else fehlermeldung(obj.message);
